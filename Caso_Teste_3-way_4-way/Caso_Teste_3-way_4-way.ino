// Neste código foi exemplificado a conexão de um 4-way de forma lógica
...
void loop() {
  ...
  // 3-way
  checkSwitchState(SWITCH_PIN_2, &state_button_2, &state_1, OUT_1, RELAY_PIN_1);
  // 4-way 
  checkSwitchState(SWITCH_PIN_3, &state_button_3, &state_1, OUT_1, RELAY_PIN_1);
}
