// Neste código foi exemplificado o código principal
// na qual os interruptores comandam os pontos de iluminação
// e as cargas podem ser controladas via voz ou aplicativo
...
void loop() {
  ...
  checkSwitchState(SWITCH_PIN_1, &state_button_1, &state_1, OUT_1, RELAY_PIN_1);
  checkSwitchState(SWITCH_PIN_2, &state_button_2, &state_2, OUT_3, RELAY_PIN_3);
  checkSwitchState(SWITCH_PIN_3, &state_button_3, &state_3, OUT_4, RELAY_PIN_5);
}
